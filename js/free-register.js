...
sendBtn.onclick = function(){
    if(fname.value != '' && lname.value != '' && email.value != ''){
        if(office.value != '' && phone.value != '' & website.value != ''){
            if(firm.value != '' && county.value != '' && state.value != '' & city.value != '' && service.value != ''){
                        ...
                        .then((val) => {
                            ...
                            storage.put(firstFile).then(function(snap){
                                snap.ref.getDownloadURL().then(function(imageUrl){
                                    ...
                                    //create user data
                                    firestore.collection('users').doc(val.user.uid)
                                    .set({
                                        ...
                                        location.href = '/thank-you.html?id='+val.user.uid;
                                    });
                                });
                            });
                        }).catch((error) => {
